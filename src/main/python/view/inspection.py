...
#        self.serving_dobot.dobot_req.connect(self.on_clicked_inspect_button)
        self.serving_dobot.dobot_req.connect(self.on_get_img_from_camera)
...
#        self.camera_model.capture(Project.project_path() + '/tmp')
    ...
    def on_finished_predicting(self, result):
        ...
        if 'OK' in prediction :
            ...
            self.ui.ng_score.setText(w_score + '\nLabel: ' +
                                     prediction)
...
#                return
    ...
    def alert_for_truncated_image(self, path):
        ...
        self.msgBox.setText('This image may be damaged. Inspection will be skipped.\n\n'
                            + 'Please press OK to continue your inspection.' + path)
        self.msgBox.exec()
