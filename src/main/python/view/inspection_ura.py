...
#    @property
#    def ura_counter(self):
#        return self.__ura_counter

#    @ura_counter.setter
#    def ura_counter(self, new_value):
#        self.__ura_counter = new_value
#        self.ui.URA_counter_label.setText(str(self.ura_counter))
